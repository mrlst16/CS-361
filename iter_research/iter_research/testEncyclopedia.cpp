...
UnitTest(EncyclopediaAddCourse) {
	cout << "Memory beginning on EncyclopediaAddCourse " << MemoryChecked::getCurrentCount() << endl;
...
UnitTest(EncyclopediaRemoveCourse) {
	cout << "Memory beginning on EncyclopediaRemoveCourse " << MemoryChecked::getCurrentCount() << endl;
	Topic alphabet ("Alphabet", 15);
	Topic commerce ("Commerce", 25);
	Topic sailing ("Sailing", 36);
	Topic mapping ("Mapping", 30);
...
UnitTest(EncyclopediaCopy) {
	cout << "Memory beginning on EncyclopediaCopy " << MemoryChecked::getCurrentCount() << endl;
	Topic alphabet ("Alphabet", 15);
	Topic commerce ("Commerce", 25);
	Topic sailing ("Sailing", 36);
	Topic mapping ("Mapping", 30);
...
UnitTest(EncyclopediaAssign) {
	cout << "Memory beginning on EncyclopediaAssign " << MemoryChecked::getCurrentCount() << endl;
	Topic alphabet ("Alphabet", 15);
	Topic commerce ("Commerce", 25);
	Topic sailing ("Sailing", 36);
	Topic mapping ("Mapping", 30);
	...
	Encyclopedia enc;
	enc.addPlanRequirement(commerce, alphabet);
	cout << "Memory after addPlanRequirement on EncyclopediaAssign " << MemoryChecked::getCurrentCount() << endl;
	enc.addPlanRequirement(trading, sailing);
	cout << "Memory after addPlanRequirement on EncyclopediaAssign " << MemoryChecked::getCurrentCount() << endl;
	enc.addPlanRequirement(trading, mapping);
	cout << "Memory after addPlanRequirement on EncyclopediaAssign " << MemoryChecked::getCurrentCount() << endl;
	...
	assertThat(enc2, isNotEqualTo(enc));
    cout << "Memory after line \"assertThat(enc2, isNotEqualTo(enc));\" on EncyclopediaAddCourse " << MemoryChecked::getCurrentCount() << endl;
    ...
    assertThat (plan.getTopic(), isEqualTo(trading));
    assertThat(plan.getNumberOfRequirements(), isEqualTo(2));
    cout << "Memory end of on EncyclopediaAddCourse " << MemoryChecked::getCurrentCount() << endl;
...
UnitTest(EncyclopediaRead) {
	cout << "Memory beginning on EncyclopediaRead " << MemoryChecked::getCurrentCount() << endl;
